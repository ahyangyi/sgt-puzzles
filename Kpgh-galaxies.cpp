...
bool GalaxiesGameHandler::contains(const QPointF& point, const QList< KnotRendererBatch::KnotBatchAction* >& batch)
{
    return DefaultGameHandler::contains(point, batch);
}
